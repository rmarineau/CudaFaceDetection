...
class MyIntImage : public Managed
{
public:
    int width;
    int height;
...
void createImage(int width, int height, MyImage *image, cudaStream_t thsStream);
void createSumImage(int width, int height, MyIntImage *image, cudaStream_t thsStream);
